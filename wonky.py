...
class ConnectFourUI(pyglet.window.Window):
    ...
    def draw_difficulty_selection_screen(self):
        ...
        hard_button.draw()
        hard_button.label.draw()

    def draw_game_board(self):
        pyglet.gl.glClearColor(0.3, 0.3, 0.3, 1.0)  # Darker background
        
        # Draw the player indicators
        pyglet.shapes.Circle(50, 550, 25, color=(255, 0, 0)).draw()  # Player (red) indicator
        pyglet.shapes.Circle(750, 550, 25, color=(255, 255, 0)).draw()  # AI (yellow) indicator
         # Draw labels for "You" and "AI"
        you_label = pyglet.text.Label(
            "You",
            font_name="Arial",
            font_size=16,
            x=50,
